...
<body class="chats-tab-open">
    ...
    <div class="main-layout is-rtl">
                        ...
                        <div class="hide-scrollbar h-100" id="chatContactsList">
                            ...
                            <div class="sidebar-header sticky-top p-2">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <h5 class="font-weight-semibold mb-0">چت ها</h5>
                                    <!-- Chat Tab Pane Title End -->

                                    <ul class="nav flex-nowrap">

                                        <li class="nav-item list-inline-item mr-1">
                                            <a class="nav-link text-muted px-1" href="#" title="اطلاعیه" role="button" data-toggle="modal" data-target="#notificationModal">
                                                <!-- Default :: Inline SVG -->
                                        ...
                                        <li class="nav-item list-inline-item mr-0">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-left">
                                                    <a class="dropdown-item" href="#" role="button" data-toggle="modal" data-target="#startConversation">چت جدید</a>
                                                    <a class="dropdown-item" href="#" role="button" data-toggle="modal" data-target="#createGroup">ایجاد گروه</a>
                                                    <a class="dropdown-item" href="#" role="button" data-toggle="modal" data-target="#inviteOthers">دیگران را دعوت کنید</a>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
                                ...
                                <div class="sidebar-sub-header">
                                    ...
                                    <div class="dropdown mr-2">
                                        ...
                                        <!-- Dropdown Menu Start -->
                                        <div class="dropdown-menu dropdown-menu-left">
                                            <a class="dropdown-item" data-chat-filter="" data-select="all-chats" href="#">همه چت ها</a>
                                            <a class="dropdown-item" data-chat-filter="" data-select="friends" href="#">دوستان</a>
                                            <a class="dropdown-item" data-chat-filter="" data-select="groups" href="#">گروه ها</a>
                                            <a class="dropdown-item" data-chat-filter="" data-select="unread" href="#">خوانده نشده</a>
                                            <a class="dropdown-item" data-chat-filter="" data-select="archived" href="#">بایگانی شد</a>
                                        </div>
                                        <!-- Dropdown Menu End -->
                                    </div>
                                    ...
                                    <form class="form-inline">
                                        <div class="input-group">
                                            <input type="text" class="form-control search border-right-0 transparent-bg pr-0" placeholder="جستجوی کاربران...">
                    ...
                    <div class="d-flex flex-column h-100">
                        <div class="hide-scrollbar h-100" id="callContactsList">
                            ...
                            <div class="sidebar-header sticky-top p-2">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <!-- Chat Tab Pane Title Start -->
                                    <h5 class="font-weight-semibold mb-0">تماس می گیرد</h5>
                                    <!-- Chat Tab Pane Title End -->
                    ...
                    <div class="d-flex flex-column h-100">
                        <div class="hide-scrollbar" id="friendsList">
                            ...
                            <div class="sidebar-header sticky-top p-2">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <!-- Chat Tab Pane Title Start -->
                                    <h5 class="font-weight-semibold mb-0">دوستان</h5>
                                    <!-- Chat Tab Pane Title End -->
                            ...
                            <ul class="contacts-list" id="friendsTab" data-friends-list="">
                                <!-- Item Series Start -->
                                <li>
                                    <small class="font-weight-medium text-uppercase text-muted">آ</small>
                                </li>
                                <!-- Item Series End -->
                                ...
                                <!-- Item Series Start -->
                                <li>
                                    <small class="font-weight-medium text-uppercase text-muted">ب</small>
                                </li>
                                <!-- Item Series End -->
                                ...
                                <!-- Item Series Start -->
                                <li>
                                    <small class="font-weight-medium text-uppercase text-muted">سی</small>
                                </li>
                                <!-- Item Series End -->
                                ...
                                <!-- Item Series Start -->
                                <li>
                                    <small class="font-weight-medium text-uppercase text-muted">جی</small>
                                </li>
                                <!-- Item Series End -->
                                ...
                                <!-- Item Series Start -->
                                <li>
                                    <small class="font-weight-medium text-uppercase text-muted">ک</small>
                                </li>
                                <!-- Item Series End -->
                                ...
                                <!-- Item Series Start -->
                                <li>
                                    <small class="font-weight-medium text-uppercase text-muted">متر</small>
                                </li>
                                <!-- Item Series End -->
                                ...
                                <!-- Item Series Start -->
                                <li>
                                    <small class="font-weight-medium text-uppercase text-muted">س</small>
                                </li>
                                <!-- Item Series End -->
                                            ...
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li class="list-group-item py-2">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <!-- Alternate :: External File link -->
                                                        <!-- <img class="injectable text-muted hw-20 ml-1" src="./../assets/media/icons/InstaCgram.svg" alt=""> -->
                                                    </div>
                                                </li>
                                                <!-- List Group Item End -->
                ...
                <div class="chat-body">
                    ...
                    <div class="chat-header">
                        ...
                        <div class="media chat-name align-items-center text-truncate">
                            <div class="comingavatar avatar avatar-online d-none d-sm-inline-block mr-3">
                                <img src="../assets/media/avatar/2.png" alt="" >
                            </div>

                            <div class="comingname media-body align-self-center ">
                                <h6 class="text-truncate mb-0" id="changingname">کاترین ریچاردسون</h6>
                                <small class="text-muted" id="comingstatus">برخط</small>
                            </div>
                        </div>
                        ...
                        <ul class="nav flex-nowrap">
                            ...
                            <li class="nav-item list-inline-item d-none d-sm-block mr-1">
                                <a class="nav-link text-muted px-1" href="#" title="اضافه کردن مردم">
                                    <!-- Default :: Inline SVG -->
                                    <svg class="hw-20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                                    </svg>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-left">
                                        ...
                                        <a class="dropdown-item align-items-center d-flex" href="#">
                                            ...
                                            <span>نادیده گرفتن اعلان ها</span>
                                        </a>
                                        <a class="dropdown-item align-items-center d-flex" href="#">
                                            <!-- Default :: Inline SVG -->
                                            <svg class="hw-20 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="collapse border-bottom px-3" id="searchCollapse">
                        <div class="container-xl py-2 px-0 px-md-3">
                            <div class="input-group bg-light ">
                                <input type="text" class="form-control form-control-md border-right-0 transparent-bg pr-0" placeholder="جستجو کردن...">
                                <div class="input-group-append">
                        ...
                        <div class="container">
                            ...
                            <div class="message-day">
                                ...
                                <div class="message">
                                    <div class="message-wrapper">
                                        <div class="message-content">
                                            <span id="message">من باید روز جمعه در مورد گرم شدن کره زمین سخنرانی کنم و خیلی عصبی هستم.</span>
                                        </div>
                                    </div>
                                    <div class="message-options">
                                        <div class="comingavatar avatar avatar-sm" ><img alt="" src="../assets/media/avatar/6.png"></div>
                                        <span class="message-date" id="time">9:12 صبح</span>
                                        <div class="dropdown">
                                ...
                                <div class="message self">
                                    <div class="message-wrapper">
                                        <div class="message-content">
                                            <span id="message-chat">اول از همه، شما باید موضوع را به طور کامل درک کنید. شما باید بدانید گرمایش زمین چیست، چه چیزی باعث گرم شدن کره زمین می شود و مردم برای کاهش اثرات گرمایش جهانی چه باید بکنند.</span>
                                        </div>
                                    </div>
                                    <div class="message-options">
                                        <div class="avatar avatar-sm"><img alt="" src="../assets/media/avatar/6.png"></div>

                                        <span class="message-date">9:12 صبح</span>
                                        <span class="message-status">ویرایش شده</span>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col">
                                    <div class="input-group">
                                        ...
                                        <!-- Textarea Start-->
                                        <textarea class="form-control transparent-bg border-0 no-resize hide-scrollbar" placeholder="پیام خود را بنویسید..." rows="1"></textarea>
                                        <!-- Textarea End -->
                                    </div>
                                </div>
                                ...
                                <div class="col-auto">
                                    <div class="btn btn-primary btn-icon rounded-circle text-light mb-1" role="button">
                                        <!-- Default :: Inline SVG -->
                                        <svg class="hw-24 rotate-y" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="d-flex h-100 flex-column">
                            ...
                            <div class="container-fluid">
                                <ul class="nav justify-content-between align-items-center">
                                    ...
                                    <li class="text-center">
                                        <h5 class="text-truncate mb-0">جزئیات نمایه</h5>
                                    </li>
                                    <!-- Sidebar Title End -->
                        ...
                        <div class="hide-scrollbar flex-fill">
                            ...
                            <div class="text-center p-3">
                                ...
                                <div class="comingavatar avatar avatar-xl mx-5 mb-3">
                                    <img class=" avatar-img" src="../assets/media/avatar/2.png" alt="">
                                </div>

                                <!-- User Info -->
                                <div class="comingname">
                                <h6 class=" mb-1">کاترین ریچاردسون</h6>
                                </div>
                                <p class="text-muted d-flex align-items-center justify-content-center">
                                    ...
                                    <span>سان فرانسیسکو، کالیفرنیا</span>
                                </p>
                                        ...
                                        <ul class="list-group list-group-flush">
                                                ...
                                                <div class="document">
                                                    ...
                                                    <div class="document-body">
                                                        <h6 class="text-truncate">
                                                            <a href="#" class="text-reset" title="اثرات-گرمایش جهانی.docs">اثرات-گرمایش جهانی.docs</a>
                                                        </h6>

                                                        <ul class="list-inline small mb-0">
                                                            <li class="list-inline-item">
                                                                <span class="text-muted">79.2 کیلوبایت</span>
                                                            </li>
                                                            <li class="list-inline-item">
                                                                <span class="text-muted text-uppercase">اسناد</span>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                ...
                                                <div class="document">
                                                    ...
                                                    <div class="document-options ml-1">
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-left">
                                                                <a class="dropdown-item" href="#">چشم انداز</a>
                                                                <a class="dropdown-item" href="#">اشتراک گذاری</a>
                                                                <a class="dropdown-item" href="#">حذف</a>
                                                            </div>
                                                        </div>
                                            ...
                                            <li class="list-group-item">
                                                <div class="document">
                                                    ...
                                                    <div class="document-body">
                                                        <h6 class="text-truncate">
                                                            <a href="#" class="text-reset" title="ارائه عالی در مورد گرمایش جهانی-2020.ppt">ارائه عالی در مورد گرمایش جهانی-2020.ppt</a>
                                                        </h6>
                            ...
                            <div class="card card-bg-1 mb-3">
                                <div class="card-body">
                                    <div class="d-flex flex-column align-items-center">
                                        ...
                                        <div class="d-flex flex-column align-items-center">
                                            <h5 class="mb-1">کاترین ریچاردسون</h5>
                                            <p class="text-white rounded px-2 bg-primary">98123456789</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-options">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-left">
                                            <a class="dropdown-item" href="#">پاک کردن گزارش تماس</a>
                                    ...
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div class="d-flex flex-column flex-sm-row align-items-sm-center align-items-start">
                                                <p class="text-muted mb-0">همین الان</p><span class="d-none d-sm-block text-muted mx-2">•</span>
                                                <p class="text-muted mb-0">2دقیقه 35ثانیه</p>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div class="d-flex flex-column flex-sm-row align-items-sm-center align-items-start">
                                                <p class="text-muted mb-0">5 دقیقه پیش</p><span class="d-none d-sm-block text-muted mx-2">•</span>
                                                <p class="text-muted mb-0">12دقیقه 35ثانیه</p>
                                            </div>
                                        </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            <h6 class="text-danger">تماس از دست رفته</h6>

                                            <div class="d-flex flex-column flex-sm-row align-items-sm-center align-items-start">
                                                <p class="text-muted mb-0">18 دقیقه پیش</p>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div class="d-flex flex-column flex-sm-row align-items-sm-center align-items-start">
                                                <p class="text-muted mb-0">دیروز در ساعت 22:45</p><span class="d-none d-sm-block text-muted mx-2">•</span>
                                                <p class="text-muted mb-0">25دقیقه 18 ثانیه</p>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div class="d-flex flex-column flex-sm-row align-items-sm-center align-items-start">
                                                <p class="text-muted mb-0">01/05/15 11:49 صبح</p><span class="d-none d-sm-block text-muted mx-2">•</span>
                                                <p class="text-muted mb-0">0دقیقه 56ثانیه</p>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="media">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div class="d-flex flex-column flex-sm-row align-items-sm-center align-items-start">
                                                <p class="text-muted mb-0">01/05/14 11:49 صبح</p><span class="d-none d-sm-block text-muted mx-2">•</span>
                                                <p class="text-muted mb-0">19دقیقه 24ثانیه</p>
                                            </div>
                                        </div>
                            ...
                            <div class="card card-body card-bg-1 mb-3">
                                ...
                                <div class="card-options">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-left">
                                            <a class="dropdown-item" href="#">برداشتن</a>
                                            <a class="dropdown-item" href="#">مسدود کردن</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item">
                                        <div class="media align-items-center">
                                            <div class="media-body">
                                                <p class="small text-muted mb-0">اینستاگرام اینستاگرام</p>
                                                <a class="font-size-sm font-weight-medium" href="#">youruserid</a>
                                            </div>
                                            <svg class="text-muted hw-20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                                <rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect>
                                            ...
                                            <!-- <img class="injectable text-muted hw-20" src="./../assets/media/icons/InstaCgram.svg" alt=""> -->
                                        </div>
                                    </li>
                                    <li class="list-group-item">
                                        <div class="media align-items-center">
                ...
                <div class="container-xl px-2 px-sm-3">
                    <div class="row">
                        <div class="col">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="email" class="form-control form-control-md" id="emailAddress" placeholder="آدرس ایمیل خود را تایپ کنید" value="info@yoursite.com">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="webSite">سایت اینترنتی</label>
                                                <input type="text" class="form-control form-control-md" id="webSite" placeholder="وب سایت خود را تایپ کنید" value="www.yoursite.com">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="Address">نشانی</label>
                                                <input type="text" class="form-control form-control-md" id="Address" placeholder="آدرس خود را تایپ کنید" value="ایران، مازندران، بابل، خ نادر، پلاک 1234">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h6 class="mb-1">پروفایل شبکه های اجتماعی</h6>
                                    <p class="mb-0 text-muted small">اطلاعات شخصی و تماس را به روز کنید</p>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="facebookId">فیس بوک</label>
                                                <input type="text" class="form-control form-control-md" id="facebookId" placeholder="نام کاربری">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="twitterId">توییتر</label>
                                                <input type="text" class="form-control form-control-md" id="twitterId" placeholder="نام کاربری">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="InstaCgramId">اینستاگرام</label>
                                                <input type="text" class="form-control form-control-md" id="InstaCgramId" placeholder="نام کاربری">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                <label for="linkedinId">لینکدین</label>
                                                <input type="text" class="form-control form-control-md" id="linkedinId" placeholder="نام کاربری">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="password" class="form-control form-control-md" id="current-password" placeholder="رمز عبور فعلی" autocomplete="on">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="password" class="form-control form-control-md" id="new-password" placeholder="رمز عبور جدید" autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label for="repeat-password">تکرار رمز عبور</label>
                                                    <input type="password" class="form-control form-control-md" id="repeat-password" placeholder="تکرار رمز عبور" autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                    </form>
                                ...
                                <div class="card-body p-0">
                                    <ul class="list-group list-group-flush list-group-sm-column">
                                        ...
                                        <li class="list-group-item py-2">
                                            <div class="media align-items-center">
                                                <div class="media-body">
                                                    <p class="mb-0">عکس پروفایل</p>
                                                    <p class="small text-muted mb-0">انتخاب کنید چه کسی می تواند عکس نمایه من را ببیند</p>
                                                </div>
                                                <div class="dropdown mr-2">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-left">
                                                        <a class="dropdown-item" href="#">عمومی</a>
                                                        <a class="dropdown-item" href="#">دوستان</a>
                                                        <a class="dropdown-item" href="#">دوستان منتخب</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
                                        ...
                                        <li class="list-group-item py-2">
                                            <div class="media align-items-center">
                                                <div class="media-body">
                                                    <p class="mb-0">آخرین بازدید</p>
                                                    <p class="small text-muted mb-0">انتخاب کنید چه کسی می تواند آخرین حضور من را ببیند</p>
                                                </div>
                                                <div class="dropdown mr-2">
                                                    <button class="btn btn-outline-default dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                        عمومی
                                        ...
                                        <li class="list-group-item py-2">
                                            <div class="media align-items-center">
                                                <div class="media-body">
                                                    <p class="mb-0">گروه ها</p>
                                                    <p class="small text-muted mb-0">انتخاب کنید چه کسی می تواند شما را در گروه ها اضافه کند</p>
                                                </div>
                                                <div class="dropdown mr-2">
                                                    <button class="btn btn-outline-default dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                        عمومی
                                        ...
                                        <li class="list-group-item py-2">
                                            <div class="media align-items-center">
                                                <div class="media-body">
                                                    ...
                                                    <p class="small text-muted mb-0">انتخاب کنید چه کسی می‌تواند به‌روزرسانی‌های وضعیت من را ببیند</p>
                                                </div>
                                                <div class="dropdown mr-2">
                                                    <button class="btn btn-outline-default dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                        عمومی
                                        ...
                                        <li class="list-group-item py-2">
                                            <div class="media align-items-center">
                                                <div class="media-body">
                                                    <p class="mb-0">رسیدها را بخوانید</p>
                                                    <p class="small text-muted mb-0">اگر این گزینه را خاموش کنید، نمی‌توانید رسپی‌های خواندن را ببینید</p>
                                                </div>
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body p-0">
                                    <ul class="list-group list-group-flush list-group-sm-column">
                                        <li class="list-group-item py-2">
                                            <div class="media align-items-center">
                                                <div class="media-body">
                                                    <p class="mb-0">از احراز هویت دو مرحله ای استفاده کنید</p>
                                                    <p class="small text-muted mb-0">در صورت تلاش برای ورود از یک دستگاه یا مرورگر ناشناس، یک کد بخواهید.</p>
                                                </div>
                                                <div class="custom-control custom-switch mr-2">
                                        ...
                                        <li class="list-group-item py-2">
                                            <div class="media align-items-center">
                                                <div class="media-body">
                                                    <p class="mb-0">در مورد ورودهای ناشناس هشدار دریافت کنید</p>
                                                    <p class="small text-muted mb-0">اگر کسی از دستگاه یا مرورگری که معمولاً از آن استفاده نمی کنید وارد سیستم شود، به شما اطلاع داده می شود</p>
                                                </div>
                                                <div class="custom-control custom-switch mr-2">
                                ...
                                <div class="card-footer d-flex justify-content-end">
                                    <button class="btn btn-link text-muted mx-1">بازنشانی کنید</button>
                                    <button class="btn btn-primary" type="button">ذخیره تغییرات</button>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal modal-lg-fullscreen fade" id="startConversation" tabindex="-1" role="dialog" aria-labelledby="startConversationLabel" aria-hidden="true" >
            <div class="modal-dialog show modal-dialog-centered modal-dialog-scrollable" >
                <div class="modal-content" >
                    <div class="modal-header">
                        <h5 class="modal-title" id="startConversationLabel">چت جدید</h5>
                            ...
                            <div class="col-12">
                                ...
                                <form class="form-inline w-100 p-2 border-bottom">
                                    <div class="input-group w-100 bg-light">
                                        <input type="text" class="form-control form-control-md search border-right-0 transparent-bg pr-0" placeholder="جستجو کردن...">
                                        <div class="input-group-append">
                                            <div class="input-group-text transparent-bg border-left-0" role="button">
                                                <!-- Default :: Inline SVG -->
                                                <svg class="hw-20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h6 class="text-truncate">
                                                    <a href="#" class="text-reset">کاترین ریچاردسون</a>
                                                </h6>

                                                <p class="text-muted mb-0">آنلاین</p>
                                            </div>
                                        </div>
                                    </li>
                                    <!-- List Group Item End -->
                                    ...
                                    <li class="list-group-item">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h6 class="text-truncate">
                                                    <a href="#" class="text-reset">کاترین اشنایدر</a>
                                                </h6>
                                    ...
                                    <li class="list-group-item">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h6 class="text-truncate">
                                                    <a href="#" class="text-reset">بریتنی کی ویلیامز</a>
                                                </h6>

                                                <p class="text-muted mb-0">آفلاین</p>
                                            </div>
                                        </div>
                                    </li>
                                    <!-- List Group Item End -->
                                    ...
                                    <li class="list-group-item">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h6 class="text-truncate"><a href="#" class="text-reset">کریستینا ترنر</a></h6>
                                                <p class="text-muted mb-0">مشغول</p>
                                            </div>
                                        </div>
                                    </li>
                                    <!-- List Group Item End -->
                                    ...
                                    <li class="list-group-item">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h6 class="text-truncate"><a href="#" class="text-reset">آنی ریچاردسون</a></h6>
                                                <p class="text-muted mb-0">دور</p>
                                            </div>
                                        </div>
                                    </li>
                                    <!-- List Group Item End -->
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" style="">
                <div class="modal-content">
                    ...
                    <div class="modal-body py-0 hide-scrollbar">
                        <div class="row hide pt-2" data-step="1" data-title="ایجاد گروه جدید">

                            <div class="col-12">
                                <div class="form-group">
                                    <label for="groupName">اسم گروه</label>
                                    <input type="text" class="form-control form-control-md" id="groupName" placeholder="نام گروه را در اینجا تایپ کنید">
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label>عکس پروفایل را انتخاب کنید</label>
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="profilePictureInput" accept="image/*">
                                        <label class="custom-file-label" for="profilePictureInput">انتخاب فایل</label>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row hide pt-2" data-step="2" data-title="افزودن کاربران به گروه">
                        ...
                        <div class="row pt-2 h-100 hide" data-step="3" data-title="پایان">
                            <div class="col-12">
                                <div class="d-flex justify-content-center align-items-center flex-column h-100">
                                    ...
                                    <h6>گروه با موفقیت ایجاد شد</h6>
                                    <p class="text-muted text-center">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله است. </p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal modal-lg-fullscreen fade" id="inviteOthers" tabindex="-1" role="dialog" aria-labelledby="inviteOthersLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="inviteOthersLabel">دیگران را دعوت کنید</h5>
                    ...
                    <div class="modal-body hide-scrollbar">
                        <form>
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="inviteEmailAddress">آدرس ایمیل</label>
                                        <input type="email" class="form-control form-control-md" id="inviteEmailAddress" placeholder="آدرس ایمیل را در اینجا تایپ کنید" value="">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group">
                                        <label for="inviteMessage">پیام دعوت</label>
                                        <textarea class="form-control form-control-md no-resize hide-scrollbar" id="inviteMessage" placeholder="پیام خود را اینجا بنویسید" rows="3"></textarea>
                                    </div>
                                </div>
                            </div>
                        </form>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-link text-muted" data-dismiss="modal">نزدیک</button>
                        <button type="button" class="btn btn-primary">ارسال دعوتنامه</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal modal-lg-fullscreen fade" id="notificationModal" tabindex="-1" role="dialog" aria-labelledby="notificationModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="notificationModalLabel">اطلاعیه</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="بستن">
                            <span aria-hidden="true">×</span>
                        </button>
                    </div>
                                ...
                                <ul class="list-group list-group-flush  py-2">
                                    ...
                                    <li class="list-group-item">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h6>
                                                    <a href="#">کاترین ریچاردسون</a> برای شما درخواست دوستی ارسال می کند
                                                </h6>

                                                <p class="text-muted mb-0">5 دقیقه پیش</p>
                                            </div>
                                        </div>
                                        <div class="d-flex justify-content-center mt-2">
                                            <button type="button" class="btn btn-outline-danger mx-1">رد کردن</button>
                                            <button type="button" class="btn btn-primary mx-1">تایید کنید</button>
                                        </div>
                                    ...
                                    <li class="list-group-item">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h6>
                                                    <a href="#">کاتلین والدز</a> درخواست دوستی شما را پذیرفت
                                                </h6>

                                                <p class="text-muted mb-0">25 دقیقه پیش</p>
                                            </div>
                                        </div>
                                    </li>
                                    <!-- List Group Item End -->
                                    ...
                                    <li class="list-group-item">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h6>
                                                    <a href="#">اوا واکر</a> تصویر نمایه را به‌روزرسانی
                                                    کرد</h6>
                                    ...
                                    <li class="list-group-item">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h6>
                                                    <a href="#">بانی تورس</a> درخواست دوستی شما را پذیرفت
                                                </h6>
                                    ...
                                    <li class="list-group-item">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h6>
                                                    <a href="#">کریستوفر گارسیا</a> عکس پروفایل را به روز کرد
                                                </h6>
                    ...
                    <div class="modal-footer justify-content-center">
                        <button type="button" class="btn btn-link text-muted">همه را پاک کن</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        document.querySelector('.chat-finished').scrollIntoView({
            ...
            behavior: 'auto'          //"auto"  | "InstaCnt" | "smooth",
        });
        ...
        console.log(id);
         ...
         $.ajax({
                url: 'fetchchatDetail.php?id=' + id, //URL of the server-side script
                type: 'POST',
                ...
                success: function(data) {
                    ...
                    document.getElementById('time').innerHTML = response.created_at;
                    document.getElementById('message').innerHTML = response.last_message;
                   // document.getElementById('comingname').innerHTML = response.sender_name;
                    document.getElementById('comingstatus').innerHTML = response.status;
                  
                 
                    // Get references to both h6 elements
                    const h6Elements = document.querySelectorAll(".comingname h6"); // Target all h6 elements within divs with class "comingname"

                    // Update the text content of all h6 elements
                    h6Elements.forEach(h6 => {
                    h6.textContent = response.sender_name;
                    });


                    const sharedAvatars = document.querySelectorAll(".comingavatar");
                    sharedAvatars.forEach(avatar => {
                    avatar.querySelector("img").src = response.avatar;
                    });
                        ...
                        error: function(xhr, status, error) {
                         ...
                         // ajax call for chat contact tab
                         $.ajax({
                               ...
                               // drop down option on the right for category of chats
                                function dropdown(){
                                ...
                                const dropdownMenu = this.nextElementSibling; // Access the next sibling element (the dropdown menu)

                                // Get all dropdown items within the menu
                                ...
                                dropdownItems.forEach(item => {
                                    ...
                                    const selectedFilter = this.dataset.select; // Access the data-select attribute
                                    console.log("Selected filter:", selectedFilter); // For demonstration purposes

                                    // Implement your logic to switch functionality based on the selected filter
                                    switch (selectedFilter) {
                                        case "all-chats":
                                        // Code to handle "all chats" selection
                                        break;
                                        case "friends":
                                        // Code to handle "friends" selection
                                        break;
                                        case "groups":
                                        // Code to handle "groups" selection
                                        break;
                                        case "unread":
                                          // Fetch unread chat data using AJAX
                                        const xhttp = new XMLHttpRequest();
                                        xhttp.onreadystatechange = function() {
                                            if (this.readyState === 4 && this.status === 200) {
                                            // Parse the response (assuming JSON format)
                                            const unreadChats = JSON.parse(this.responseText);

                                            // Update the chatContactTab element with unread chat data
                                            updateChatContactTab(unreadChats);
                                            }
                                        };
                                        xhttp.open("GET", "chatcontacts.php?filter=unread", true); // Set filter parameter for unread chats
                                        xhttp.send();
                                        break;
                                        case "archived":
                                        // Code to handle "archived" selection
                                        break;
                                        default:
                                        // Handle any unexpected selection
                                    }
                                    });
                                });
                                });
                                ...
                                // Function to update chatContactTab with unread message(implementation details depend on your HTML structure)
                                function updateChatContactTab(unreadChats) {
                                const chatContactTab = document.getElementById("chatContactTab"); // Replace with your actual element ID
                                chatContactTab.innerHTML = ""; // Clear existing content

                                // Loop through unreadChats and create UI elements (replace with your HTML generation logic)
                                unreadChats.forEach(chat => {
                                    const contactElement = document.createElement("div"); // Create a container element
                                    contactElement.classList.add("chat-contact"); // Add a class for styling

                                    // Add content based on chat data (name, avatar, etc.)
                                    contactElement.innerHTML = `
                                    
                                    <li class="contacts-item friends"> 
                                                <a class="contacts-link" href=>
                                                    <div class="avatar avatar-online">
                                                        <img id="avatarimage" src="${chat.avatar}" alt="">
                                                    </div>
                                                    <div class="contacts-content">
                                                        <div class="contacts-info">
                                                            <h6 class="chat-name text-truncate" id="chat-name"> ${chat.sender_name} </h6>
                                                            <div class="chat-time" id="chat-time"> ${chat.created_at} </div>
                                                        </div>
                                                        <div class="contacts-texts">
                                                            <p class="text-truncate" id="chat-texts"> ${chat.last_message} </p>
                                                        </div>
                                                    </div>
                                                </a>
                                            </li>
                                   `
                                    ...
                                    chatContactTab.appendChild(contactElement);
                                });
                                }
                                ...
                                $(document).ready(function() {
                                    // Attach click event listener to each contact item
                                    $('.contacts-item').click(function() {
                                        const contactId = $(this).data('contactId');

                                        // Fetch chat content for the selected contact using AJAX
                                        $.ajax({
                                        url: '"chatcontacts.php', // Replace with your actual endpoint
                                        dataType: 'json',
                                        ...
                                        success: function(data) {
                                            ...
                                            // Loop through retrieved chat data and create elements
                                            ...
                                            const messageHtml = `
                                                ...
                                                <div class="message-options">
                                                    <div class="comingavatar avatar avatar-sm"><img alt="" src="${message.sender.avatar}"></div>
                                                    <span class="message-date" id="time">${message.timestamp}</span>
                                                    </div>
                                                </div>`;

                                            // Append the message element to chat content
