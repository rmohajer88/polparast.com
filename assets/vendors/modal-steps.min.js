!function (a) {
    ...
    a.fn.modalSteps = function (b) {
        var c = this, d = a.extend({
            btnCancelHtml: "انصراف",
            btnPreviousHtml: "بازگشت",
            btnNextHtml: "ادامه",
            btnLastStepHtml: "تمام شد",
            disableNextButton: !1,
        ...
        return c.on("show.bs.modal", function () {
            var l, m, n, o, p, b = c.find(".modal-footer"), g = b.find(".js-btn-step[data-orientation=cancel]"),
                ...
                i = b.find(".js-btn-step[data-orientation=next]"), j = d.callbacks["*"], k = d.callbacks[1];
            ...
            var m, n, o, p, b = a(this), e = c.find("#actual-step"),
                g = c.find(".js-btn-step[data-orientation=previous]"),
                h = c.find(".js-btn-step[data-orientation=next]"), i = c.find(".js-title-step"),
                j = b.data("orientation"), k = parseInt(e.val()), l = d.callbacks["*"];
